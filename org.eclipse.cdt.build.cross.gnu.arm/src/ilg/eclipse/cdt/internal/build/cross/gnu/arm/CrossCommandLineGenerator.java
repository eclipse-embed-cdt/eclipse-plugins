...
public class CrossCommandLineGenerator extends ManagedCommandLineGenerator {
	...
	public IManagedCommandLineInfo generateCommandLineInfo(ITool tool,
		...
		return super.generateCommandLineInfo(tool, newCommandName, newFlags,
	...
	private String[] gatherFlags(ITool oTool, String[] asFlags) {
		...
		if (oParent != null && (oParent instanceof IToolChain)) {
			...
			for (IOption oOption : aoOptions) {
				...
				IOptionCategory cat = oOption.getCategory();
				IOptionCategoryApplicability catApplicabilityCalculator = cat
						.getApplicabilityCalculator();

				IBuildObject config = null;
				IBuildObject parent = oTool.getParent();
				...
				if ((catApplicabilityCalculator == null || catApplicabilityCalculator
						.isOptionCategoryVisible(config, oToolChain, cat))
						&& (applicabilityCalculator == null || applicabilityCalculator
								.isOptionUsedInCommandLine(config, oToolChain,
										oOption))) {
