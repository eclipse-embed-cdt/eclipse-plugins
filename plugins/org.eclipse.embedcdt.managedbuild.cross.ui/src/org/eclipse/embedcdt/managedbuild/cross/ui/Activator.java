...
public class Activator extends AbstractUIActivator {
	...
	public PersistentPreferences getPersistentPreferences() {
		return org.eclipse.embedcdt.managedbuild.cross.core.Activator.getInstance().getPersistentPreferences();
	}

	public DefaultPreferences getDefaultPreferences() {
		return org.eclipse.embedcdt.managedbuild.cross.core.Activator.getInstance().getDefaultPreferences();
	}
