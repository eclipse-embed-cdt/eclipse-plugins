...
public class Activator extends AbstractUIActivator {
	...
	public static final String CORE_PLUGIN_ID = "org.eclipse.embedcdt.managedbuild.cross.core"; //$NON-NLS-1$
	...
	public PersistentPreferences getPersistentPreferences() {
		return org.eclipse.embedcdt.internal.managedbuild.cross.core.Activator.getInstance().getPersistentPreferences();
	}

	public DefaultPreferences getDefaultPreferences() {
		return org.eclipse.embedcdt.internal.managedbuild.cross.core.Activator.getInstance().getDefaultPreferences();
	}
