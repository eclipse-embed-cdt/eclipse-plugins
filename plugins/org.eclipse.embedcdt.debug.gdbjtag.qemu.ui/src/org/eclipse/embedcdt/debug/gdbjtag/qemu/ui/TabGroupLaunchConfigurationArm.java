...
public class TabGroupLaunchConfigurationArm extends TabGroupLaunchConfiguration {
	...
	public void createTabs(ILaunchConfigurationDialog dialog, String mode) {
		...
		TabStartup tabStartup = new TabStartup(architecture);

		ILaunchConfigurationTab tabs[] = new ILaunchConfigurationTab[] { new TabMain(),
				new TabDebugger(tabStartup, architecture), tabStartup, new SourceLookupTab(), new CommonTab(), new TabSvd() };
