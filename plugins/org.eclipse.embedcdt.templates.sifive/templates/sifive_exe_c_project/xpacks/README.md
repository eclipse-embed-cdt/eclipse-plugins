...
```console
$ git rm --cached plugins/org.eclipse.embedcdt.templates.sifive/templates/sifive_exe_c_project/xpacks/sifive-templates
$ git rm --cached plugins/org.eclipse.embedcdt.templates.sifive/templates/sifive_exe_c_project/xpacks/micro-os-plus-diag-trace
$ git rm --cached plugins/org.eclipse.embedcdt.templates.sifive/templates/sifive_exe_c_project/xpacks/micro-os-plus-startup
$ git rm --cached plugins/org.eclipse.embedcdt.templates.sifive/templates/sifive_exe_c_project/xpacks/micro-os-plus-c-libs
$ git rm --cached plugins/org.eclipse.embedcdt.templates.sifive/templates/sifive_exe_c_project/xpacks/micro-os-plus-cpp-libs
$ git rm --cached plugins/org.eclipse.embedcdt.templates.sifive/templates/sifive_exe_c_project/xpacks/micro-os-plus-riscv-arch
$ git rm --cached plugins/org.eclipse.embedcdt.templates.sifive/templates/sifive_exe_c_project/xpacks/sifive-devices
$ git rm --cached plugins/org.eclipse.embedcdt.templates.sifive/templates/sifive_exe_c_project/xpacks/sifive-arty-boards
$ git rm --cached plugins/org.eclipse.embedcdt.templates.sifive/templates/sifive_exe_c_project/xpacks/sifive-hifive1-board
```
