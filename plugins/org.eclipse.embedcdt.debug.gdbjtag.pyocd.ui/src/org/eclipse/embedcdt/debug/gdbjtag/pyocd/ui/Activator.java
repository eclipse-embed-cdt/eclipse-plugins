...
public class Activator extends AbstractUIActivator {
	...
	public DefaultPreferences getDefaultPreferences() {
		return org.eclipse.embedcdt.debug.gdbjtag.pyocd.core.Activator.getInstance().getDefaultPreferences();
	}

	public PersistentPreferences getPersistentPreferences() {
		return org.eclipse.embedcdt.debug.gdbjtag.pyocd.core.Activator.getInstance().getPersistentPreferences();
	}
