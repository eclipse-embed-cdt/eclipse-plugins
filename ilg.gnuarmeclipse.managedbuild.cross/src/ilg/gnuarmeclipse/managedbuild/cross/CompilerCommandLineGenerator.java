...
public class CompilerCommandLineGenerator extends ManagedCommandLineGenerator {
			...
			String[] inputResources, String commandLinePattern)
	{
		...
		lineInfo = super.generateCommandLineInfo(tool, commandName, flags, outputFlag, outputPrefix, outputName, inputResources, commandLinePattern);
		...
		return new ManagedCommandLineInfo(newCommandLine, lineInfo.getCommandLinePattern(), lineInfo.getCommandName(), newFlags,
				lineInfo.getOutputFlag(), lineInfo.getOutputPrefix(), lineInfo.getOutput(), lineInfo.getInputs());
	}
