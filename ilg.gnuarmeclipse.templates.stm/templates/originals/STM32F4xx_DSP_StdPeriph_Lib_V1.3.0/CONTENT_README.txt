This is the original STM stsw-stm32065 stm32f4_dsp_stdperiph_lib.zip v1.3 
archive, with the following folders removed to save space:

- _htmresc
- Project
- Utilities
- Libraries/CMSIS/Documentation
