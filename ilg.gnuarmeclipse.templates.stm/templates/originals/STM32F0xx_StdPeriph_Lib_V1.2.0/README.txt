...
STM STSW-STM32048 stm32f0_stdperiph_lib.zip archive.
...
- a family initialisation file (startup_stm32f0xx.c)
- the interrupt vectors (vectors_stm32f0xx.c)
...
there is no need to use the stm32f0xx_it.* files, since the default
system handlers are already defined in the vectors_stm32f0xx.c file.
